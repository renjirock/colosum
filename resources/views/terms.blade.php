...
<html lang="en">
    <head>
        ...
        <title>Colosum - TERMS OF SERVICE</title>
        ...
        <header class="bg-gradient-primary-to-secondary pt-5 py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">TERMS OF SERVICE</h1>
                </div>
            </div>
        </header>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-9 m-3 p-3">
                        <p>
                            This website is operated by Colosum. Throughout the site, the terms “we”, “us” and “our” refer
                            to Colosum. Colosum offers this website, including all information, tools and Services available
                        ...
                        <p>
                            (a) for any unlawful purpose; (b) to solicit others to perform or participate in any unlawful
                            acts; (c) to violate any international, federal, provincial or state regulations, rules, laws,
                        ...
                        <p>
                            ...
                            In no case shall Colosum, our directors, officers, employees, affiliates, agents, contractors,
                        ...
                        <p>
                            You agree to indemnify, defend and hold harmless Colosum and our parent, subsidiaries,
                        ...
                        <p>
                            ...
                            governed by and construed in accordance with the laws of Colombia.
                        </p>
                        <h3>
                        ...
                        <p>
                            Questions about the Terms of Service should be sent to us at hello@colosum.co.
                        </p>
                        <p>
